...
internal static class InteropProperties
{
    ...
    // RandoMapCore will try to position the pin with the following priority:
    ...
    internal static readonly MetadataProperty<AbstractPlacement, RawLogicDef[]> LocationHints =
        new("LocationHints", (placement) => RmcPinManager.Dpm.GetDefaultLocationHints(placement.Name));

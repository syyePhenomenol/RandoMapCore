    ...
    : ProgressionSynchronizer(logicExtender, ctx)
{
    ...
    private static readonly Dictionary<(string, string), string> _sceneBoolTerms =
        new()
        {
            ...
            { ("Fungus2_21", "Quake Floor"), "RMC-Broke_Pilgrim's_Way_Quake_Floor" },
            ...
            { ("RestingGrounds_10", "Collapser Small (5)"), "RMC-Broke_Crypts_One_Way_Floor" },
            ...
            { ("Ruins1_31", "Breakable Wall Ruin Lift"), "RMC-Broke_City_Toll_Wall" },

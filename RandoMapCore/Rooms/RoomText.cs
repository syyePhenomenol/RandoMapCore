...
internal class RoomText : ColoredMapObject, ISelectable
{
    ...
    {
        return RmcPathfinder.Slt.GetRoomActive(Rtd.SceneName);
    }
    ...
    public override void UpdateColor()
    {
        if (_selected)
        {
            Color = RmcColors.GetColor(RmcColorSetting.Room_Selected);
        }
        else
        {
            Color = RmcPathfinder.Slt.GetRoomColor(Rtd.SceneName);
        }
    }
}
